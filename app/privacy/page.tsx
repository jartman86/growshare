        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-green dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Personal Information</h3>
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Automatically Collected Information</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">User-Generated Content</h3>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Other Users</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Your profile information, listings, and reviews are visible to other users as part of the platform's functionality.
              </p>

              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Service Providers</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Legal Requirements</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Access and Update</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                You can access and update your profile information through your account settings.
              </p>

              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Email Preferences</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Account Deletion</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 mb-2">Data Portability</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">8. International Users</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">9. California Privacy Rights</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
