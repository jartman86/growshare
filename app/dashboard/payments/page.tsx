            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center py-2 border-b">
                  <span className="text-gray-700">7+ days before start</span>
                  <span className="font-medium text-green-600">100% refund</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b">
                  <span className="text-gray-700">3-6 days before start</span>
                  <span className="font-medium text-amber-600">50% refund</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-700">Less than 3 days before start</span>
