      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-green dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">3. Platform Services</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">4. Landowner Responsibilities</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">5. Renter Responsibilities</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">6. Payments and Fees</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">7. Cancellation Policy</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">8. Prohibited Activities</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">11. Dispute Resolution</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">13. Termination</h2>
              <p className="text-gray-700 dark:text-gray-300">
