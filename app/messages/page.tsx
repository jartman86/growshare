...
function MessagesPageContent() {
  ...
  const formattedConversations = conversations.map(c => ({
    ...
    lastMessage: {
      id: c.lastMessage.id,
      conversationId: c.userId,
      senderId: c.lastMessage.senderId,
      senderName: c.lastMessage.senderId === currentUserId ? 'You' : `${c.user.firstName} ${c.user.lastName}`,
      senderAvatar: c.lastMessage.senderId === currentUserId ? '' : (c.user.avatar || ''),
  ...
  const selectedConvFormatted = selectedConversation ? {
    ...
    lastMessage: {
      ...
      senderName: selectedConversation.lastMessage.senderId === currentUserId ? 'You' : `${selectedConversation.user.firstName} ${selectedConversation.user.lastName}`,
      senderAvatar: selectedConversation.lastMessage.senderId === currentUserId ? '' : (selectedConversation.user.avatar || ''),
      content: selectedConversation.lastMessage.content,
      timestamp: new Date(selectedConversation.lastMessage.createdAt),
      read: selectedConversation.lastMessage.isRead,
    },
